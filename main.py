...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption ("Aidan's Alien Invasion")
        ...
        # set initial score to zero (added by me)
        self.score = 0 
    ...
    def _check_keydown_events(self, event):
        ...
        # Did the player hit the Q key to quite the game?
            ...
            sys.exit()
        # Did the player hit the space bar and shoot a bullet
    ...
    def _game_display(self):
        # Prints score and number of ships left (added by me)
        font = pygame.font.Font('freesansbold.ttf', 50)
        text = font.render(f'Score: {self.score}                    Ships Left: {self.stats.ships_left}', True, (255, 255, 255), (125, 25, 200))
        textRect = text.get_rect()
        textRect.center = ((self.settings.screen_width / 2), 50)
    ...
    def _update_screen(self):
        ...
        # Display ships left and Score (added by me)
        self._game_display()
